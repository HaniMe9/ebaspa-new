-- EBASPA Database Seed Data for MySQL
...
('member_001', 'user_002', 'Ethiopian Business Consulting Group', 'John Doe', 'member1@consulting.com', '+251 911 123 456', 'www.ebcg.com', 'Bole Road, Addis Ababa', 'Addis Ababa', 'Addis Ababa', 'FULL', 'ACTIVE', 'Leading business consulting firm specializing in SME development and strategic planning.', '["Business Strategy", "SME Development", "Market Research"]', '["ISO 9001", "Business Excellence Award 2023"]'),
('member_002', 'user_003', 'Addis Training Institute', 'Jane Smith', 'member2@training.com', '+251 922 234 567', 'www.addistraining.com', 'Kazanchis, Addis Ababa', 'Addis Ababa', 'Addis Ababa', 'FULL', 'ACTIVE', 'Professional training institute offering capacity building programs for businesses.', '["Training Programs", "Capacity Building", "Skills Development"]', '["TVET Certified", "Training Excellence Award"]'),
('member_003', 'user_004', 'Tech Solutions Ethiopia', 'Mike Johnson', 'member3@tech.com', '+251 933 345 678', 'www.techsolutions.et', 'ICT Park, Addis Ababa', 'Addis Ababa', 'Addis Ababa', 'FULL', 'ACTIVE', 'Technology solutions provider helping businesses digitize their operations.', '["Digital Transformation", "Software Development", "IT Consulting"]', '["Microsoft Partner", "Google Cloud Partner"]'),
('member_004', 'user_005', 'Legal Advisory Services', 'Sarah Wilson', 'member4@legal.com', '+251 944 456 789', 'www.lasethiopia.com', 'Kazanchis, Addis Ababa', 'Addis Ababa', 'Addis Ababa', 'FULL', 'ACTIVE', 'Comprehensive legal services for businesses, ensuring compliance and risk management.', '["Legal & Compliance", "Business Law", "Regulatory Affairs"]', '["Bar Association Member", "Legal Excellence Award"]'),
('member_005', 'user_006', 'Market Research Ethiopia', 'David Brown', 'member5@research.com', '+251 955 567 890', 'www.mrethiopia.com', 'Bole, Addis Ababa', 'Addis Ababa', 'Addis Ababa', 'ASSOCIATE', 'ACTIVE', 'Specialized market research and data analytics services for informed business decisions.', '["Market Research", "Data Analytics", "Business Intelligence"]', '["Research Excellence Award", "Data Quality Certified"]'),
('member_006', 'user_007', 'SME Growth Partners', 'Lisa Davis', 'member6@sme.com', '+251 966 678 901', 'www.smeethiopia.com', 'Meskel Square, Addis Ababa', 'Addis Ababa', 'Addis Ababa', 'FULL', 'ACTIVE', 'Dedicated to supporting small and medium enterprises with growth strategies and development.', '["SME Support", "Business Development", "Growth Consulting"]', '["SME Excellence Award", "Growth Partner Certified"]');
...
The program will be rolled out across major cities in Ethiopia, starting with Addis Ababa, and will be available to both EBASPA members and non-members at different pricing tiers.', 'EBASPA launches comprehensive digital transformation program to help Ethiopian SMEs leverage technology for growth and competitiveness.', 'EBASPA Team', 'Announcements', '["Digital Transformation", "SMEs", "Technology"]', TRUE, CURRENT_TIMESTAMP),
...
The agreement includes provisions for regular consultations, joint training programs, and collaborative research projects aimed at improving the quality and accessibility of business advisory services.', 'EBASPA signs partnership agreement with Ministry of Trade and Industry to strengthen business advisory services sector.', 'EBASPA Team', 'Partnerships', '["Government Partnership", "Policy Advocacy", "Capacity Building"]', TRUE, CURRENT_TIMESTAMP),
...
EBCG''s recent projects include helping a local manufacturing company increase its production capacity by 40% and supporting an agricultural cooperative to access new markets. Their success stories demonstrate the positive impact that quality business advisory services can have on Ethiopian businesses.', 'Featured member Ethiopian Business Consulting Group shares their success stories and contributions to Ethiopia''s business ecosystem.', 'EBASPA Team', 'Member Spotlight', '["Member Spotlight", "Success Stories", "Consulting"]', TRUE, CURRENT_TIMESTAMP);

-- Insert sample resources
INSERT INTO resources (id, title, description, type, url, category, tags, downloads, published) VALUES
('resource_001', 'SME Growth Toolkit', 'Comprehensive toolkit for small and medium enterprises looking to scale their operations. Includes templates, checklists, and best practices.', 'TOOLKIT', 'https://ebaspa.org/resources/sme-growth-toolkit.pdf', 'Business Development', '["SMEs", "Growth", "Toolkit"]', 150, TRUE),
('resource_002', 'Digital Marketing Guide for Ethiopian Businesses', 'Step-by-step guide to implementing digital marketing strategies for Ethiopian businesses. Covers social media, email marketing, and online advertising.', 'DOCUMENT', 'https://ebaspa.org/resources/digital-marketing-guide.pdf', 'Marketing', '["Digital Marketing", "Social Media", "Advertising"]', 89, TRUE),
('resource_003', 'Business Plan Template', 'Professional business plan template with Ethiopian market considerations. Includes financial projections and market analysis sections.', 'DOCUMENT', 'https://ebaspa.org/resources/business-plan-template.docx', 'Business Planning', '["Business Plan", "Template", "Financial Planning"]', 234, TRUE),
('resource_004', 'Capacity Building Training Video Series', 'Comprehensive video series covering essential business skills and knowledge for Ethiopian entrepreneurs and business owners.', 'VIDEO', 'https://ebaspa.org/resources/capacity-building-videos/', 'Training', '["Training", "Capacity Building", "Video Series"]', 67, TRUE),
('resource_005', 'Market Research Methodology Guide', 'Detailed guide on conducting market research in the Ethiopian context. Includes survey design, data collection, and analysis techniques.', 'DOCUMENT', 'https://ebaspa.org/resources/market-research-guide.pdf', 'Research', '["Market Research", "Methodology", "Data Analysis"]', 112, TRUE);
